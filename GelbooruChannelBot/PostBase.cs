...
namespace GelbooruChannelBot
{
    ...
    {
        protected List<string> ImportantTags = new List<string> {"#audio #loli", "#futanari", "#3d", "#yuri", "#happy_sex", "#vaginal",
           "#cum_in_pussy", "#cervical_penetration", "#x_ray", "#ahegao", "#cosplay", "#looking_at_viewer",
